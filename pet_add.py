...
class Ui_Pet_ADD(QtWidgets.QDialog):
    def error2(self):
    ...
    def setupUi(self, Pet):
        ...
        self.label_7.setGeometry(QtCore.QRect(20, 80, 121, 20))
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.label_8.setGeometry(QtCore.QRect(20, 50, 80, 16))
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.label_9.setGeometry(QtCore.QRect(20, 140, 80, 16))
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.label_10.setGeometry(QtCore.QRect(20, 170, 80, 20))
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.label_11.setGeometry(QtCore.QRect(20, 200, 120, 16))
        font = QtGui.QFont()
        font.setPointSize(8)
    ...
    def pet_input(self):
        ...
        query = f"SELECT * FROM `pet` WHERE `pet_name` = '{id}'"
        ...
        if id == '':
            ...
            mycursor.execute(
                "INSERT INTO pet (pet_name, pet_ID, type_of_animal, breed, gender, birthday, customer_name) "
