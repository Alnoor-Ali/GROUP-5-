...
class Ui_Appointment_UPDATE(object):
    def setupUi(self, Appointment):
        ...
        self.label.setGeometry(QtCore.QRect(10, 30, 150, 20))
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.comboBox.setGeometry(QtCore.QRect(160, 120, 161, 22))
        self.comboBox.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.comboBox.setObjectName("comboBox")


        self.label_4 = QtWidgets.QLabel(Appointment)
        self.label_4.setGeometry(QtCore.QRect(10, 90, 180, 20))
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.lineEdit_3.setGeometry(QtCore.QRect(160, 90, 161, 20))
        self.lineEdit_3.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.lineEdit_3.setObjectName("lineEdit_3")

        self.dateEdit = QtWidgets.QDateEdit(Appointment)
        self.dateEdit.setGeometry(QtCore.QRect(160, 60, 161, 22))
        ...
        self.comboBox_2.setGeometry(QtCore.QRect(160, 30, 161, 22))
    ...
    def check_customer(self):
        self.comboBox.clear()
        mycursor.execute("SELECT `customer_name` FROM `customer`")
        records = mycursor.fetchall()
        ...
        self.appointment_ID = self.comboBox_2.currentText()
        query = f"SELECT `customer_name` FROM `appointment` WHERE `appointment_ID` = '{self.appointment_ID}'"
        mycursor.execute(query)
    ...
    def proceed(self):
        ...
        query2 = f"UPDATE `appointment` SET `appointment_ID` = '{code}', `appointment_date` = '{date}', `appointment_status` = '{status}', `customer_name` = '{text}' WHERE `appointment_ID` = '{code}'"
    ...
    def retranslateUi(self, Appointment):
        ...
        self.label_3.setText(_translate("Appointment", "Customer Name:"))
