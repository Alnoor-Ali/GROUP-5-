...
class Ui_Customer_ADD(QtWidgets.QDialog):
    def error2(self):
    ...
    def setupUi(self, Customer):
        ...
        self.label_3.setGeometry(QtCore.QRect(10, 90, 140, 16))
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.label_4.setGeometry(QtCore.QRect(10, 120, 140, 20))
        font = QtGui.QFont()
        font.setPointSize(8)
    ...
    def customer_input(self):
        ...
        query = f"SELECT * FROM `customer` WHERE `customer_name` = '{code}'"
