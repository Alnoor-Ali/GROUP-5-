...
class Ui_Appointment_ADD(QtWidgets.QDialog):
    def error2(self):
    ...
    def setupUi(self, Appointment):
        ...
        self.label.setGeometry(QtCore.QRect(10, 30, 150, 25))
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.label_4.setGeometry(QtCore.QRect(10, 90, 160, 16))
        font = QtGui.QFont()
        font.setPointSize(8)
    ...
    def appointment_input(self):
        ...
        if code == '':
            ...
            mycursor.execute(
                "INSERT INTO appointment (appointment_ID, appointment_date, appointment_status, customer_name) "
                "VALUES (%s,%s,%s,%s)",
